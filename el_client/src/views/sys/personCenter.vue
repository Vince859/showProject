<template>
  <div class="personCenter">
    <div class="header">
      <h1 style="display: inline">个人中心</h1>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <el-button type="primary" @click="Tologin">退出登录</el-button>
    </div>
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$axios.post("/updateUser", this.ruleForm).then((res) => {
            this.$message({
              showClose: true,
              message: "修改成功",
              type: "success",
    ...
    getUser() {
      ...
      this.$axios.post("/selectUser", this.user).then((res) => {
        this.ruleForm = res.data.results[0];
      });
    },
  },
  mounted() {
